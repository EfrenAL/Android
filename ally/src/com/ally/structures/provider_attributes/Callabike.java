...
public class Callabike extends Basis_extend implements Parser {
	public Callabike(){};
	public Callabike(String icon_url, String disc, String ios_itunes_url, String ios_app_url, String android_package_name, String display_name) {
